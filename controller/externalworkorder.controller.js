...
const getExternalWorkById = async (req, res) => {
  ...
  //   if (req.params && req.params.id) {
  //     await ExternalWork.find({assetId:req.params.id}).populate('person', 'personName department')
  //     .then(data => {
  //       res.status(200).send({data: data});
  //     })
  //     .catch(error => {
  ...
  //   if (req.params && req.params.id) {
  //     await ExternalWork.find({assetId:req.params.id}).populate('person', '_id personName department')
  //     .then(data => {
